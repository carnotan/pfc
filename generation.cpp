 ...
 * vu = v / |v| = ( x /|v|,  y/|v|,  z/|v| )
 * 
 * @param population Punteiro ao std::vector<Solution> que contén á poboación.
 ...
 * @param population Punteiro a un std::vector<Solution> que contén a poboación.
 * @param cloud Punteiro a un std::vector<Point> que contén a nube de puntos.
